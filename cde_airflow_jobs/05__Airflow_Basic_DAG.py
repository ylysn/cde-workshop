...
cde_job_name_05_A = username + "_05_A_ETL"       #Replace with CDE Job Name for Script 5 A
cde_job_name_05_B = username + "_05_B_Reports"   #Replace with CDE Job Name for Script 5 B
...
default_args = {
    ...
    'end_date': datetime(2023,12,31,8)      #End Date must be in the future
}
